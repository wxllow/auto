...
pacman-key --init || abort "Failed to initialize pacman-key."
...
pacstrap /mnt base linux linux-firmware $EXTRAS || abort "Failed to install base system."
...
# Chroot
echo "Chrooting... Please run install/setup.sh in the chroot environment."
